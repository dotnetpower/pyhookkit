...
_ASSET_LICENSES = {
    ...
    "samples/scenarios/assets/approval.png": "PyHookKit original",
    "samples/scenarios/assets/deployment.png": "PyHookKit original",
    "samples/scenarios/assets/incident.png": "PyHookKit original",
    "samples/scenarios/assets/maintenance.png": "PyHookKit original",
