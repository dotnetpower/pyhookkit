...
| Example | Slack | Microsoft Teams |
|---|---|---|
| [F01 Hello World](examples/python/fundamentals/01_hello_world) | ![Hello World notification in Slack](./docs/assets/card-previews/hello-world-slack.png) | ![Hello World notification in Microsoft Teams](./docs/assets/card-previews/hello-world-teams.png) |
| [F02 Basic notification](examples/python/fundamentals/02_basic_notification) | ![Basic notification in Slack](./docs/assets/card-previews/basic-notification-slack.png) | ![Basic notification in Microsoft Teams](./docs/assets/card-previews/basic-notification-teams.png) |
| [F03 Rich card](examples/python/fundamentals/03_rich_card) | ![Rich card notification in Slack](./docs/assets/card-previews/rich-card-slack.png) | ![Rich card notification in Microsoft Teams](./docs/assets/card-previews/rich-card-teams.png) |
| [F04 Mention](examples/python/fundamentals/04_mention) | ![Mention notification in Slack](./docs/assets/card-previews/mention-slack.png) | ![Mention notification in Microsoft Teams](./docs/assets/card-previews/mention-teams.png)<ul><li><sub>Group notification requires additional Microsoft Graph member-expansion configuration.</sub></li><li><sub>Teams displays the configured user name because substituting a logical alias can misidentify the mentioned person.</sub></li></ul> |
| [F05 Link and action](examples/python/fundamentals/05_link_and_action) | ![Link and action notification in Slack](./docs/assets/card-previews/link-and-action-slack.png) | ![Link and action notification in Microsoft Teams](./docs/assets/card-previews/link-and-action-teams.png) |
| [F06 Image](examples/python/fundamentals/06_image) | ![Image notification in Slack](./docs/assets/card-previews/image-slack.png) | ![Image notification in Microsoft Teams](./docs/assets/card-previews/image-teams.png) |
| [F07 Routing](examples/python/fundamentals/07_routing) | ![Routed notification in Slack](./docs/assets/card-previews/route-slack.png) | ![Routed notification in Microsoft Teams](./docs/assets/card-previews/route-teams.png) |
| [Deployment result](examples/python/scenarios/deployment_result) | _Screenshot pending: `deployment-result-slack.png`_ | ![Bookinfo deployment result in Microsoft Teams](./docs/assets/card-previews/deployment-result-teams.png) |
| [Incident alert and acknowledgment](examples/python/scenarios/incident_alert_acknowledgment) | _Screenshot pending: `incident-alert-acknowledgment-slack.png`_ | ![Bookinfo incident alert in Microsoft Teams](./docs/assets/card-previews/incident-alert-acknowledgment-teams.png) |
| [Approval request](examples/python/scenarios/approval_request) | _Screenshot pending: `approval-request-slack.png`_ | ![Bookinfo deployment approval request in Microsoft Teams](./docs/assets/card-previews/approval-request-teams.png) |
| [Maintenance notice](examples/python/scenarios/maintenance_notice) | _Screenshot pending: `maintenance-notice-slack.png`_ | ![Scheduled maintenance notice in Microsoft Teams](./docs/assets/card-previews/maintenance-notice-teams.png) |
